...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-hooks-linking.js',
    format: 'umd',
    globals,
    name: 'react-native-hooks-linking',
    sourcemap: true,
  },
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-hooks-linking.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-hooks-linking.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-hooks-linking.esm.js',
    }),
  ],
};
